...
#include <linux/proc_fs.h>										// Proc-Filesystem Funktionen
#include <linux/platform_device.h>								// Plattform Treiber Funktionen
#include <asm/uaccess.h>
#include <asm/io.h>												// Datei I/O

#define Compatible	"xlnx,GPIO-1.0"
#define Name		"GPIO"
...
static struct platform_driver GPIO_platform_driver = {
	.probe = GPIO_probe,
	.remove = GPIO_remove,
	.driver = {			// Andreas fragen, was das hier macht
		.name = Name,
		.owner = THIS_MODULE,
...
MODULE_DEVICE_TABLE(of, Amba_of_match);	// Andreas fragen, was das hier macht
