...
# Helps bootstrapping the application when checked out from CVS/SVN.
...
# Sanity checks.
($AUTOCONF --version) >/dev/null 2>/dev/null || (echo -e "\nERROR: Cannot find '$AUTOCONF'. You need GNU autoconf to install from CVS/SVN (ftp://ftp.gnu.org/gnu/autoconf/)"; exit 1) || exit 1
($AUTOMAKE --version) >/dev/null 2>/dev/null || (echo -e "\nERROR: Cannot find '$AUTOMAKE'. You need GNU automake $required_automake_version or higher to install from CVS/SVN (ftp://ftp.gnu.org/gnu/automake/)"; exit 1) || exit 1
...
if test $using_libtool = "yes"; then
  ($LIBTOOL --version) >/dev/null 2>/dev/null || (echo -e "\nERROR: Cannot find '$LIBTOOL'. You need GNU libtool $required_libtool_version or higher to install from CVS/SVN (ftp://ftp.gnu.org/gnu/libtool/)"; exit 1) || exit 1
...
if ! egrep '^[[:space:]]*CW_AUTOMACROS(\(\[[[:digit:]]*\]\)|)[[:space:]]*([[:space:]]dnl[[:space:]]|$)' configure.ac > /dev/null; then
  echo -e "\nERROR: configure.ac must contain CW_AUTOMACROS([$(cat /home/daniel/Dropbox/Hobby/Zybo_Xilinx_Xilibus/Yocto/poky/build/tmp/work/x86_64-linux/cwautomacros-native/20110201-r0/image/home/daniel/Dropbox/Hobby/Zybo_Xilinx_Xilibus/Yocto/poky/build/tmp/sysroots/x86_64-linux/usr/share/cwautomacros/version)]). Put it for example at the top below AM_MAINTAINER_MODE."
  exit 1
fi
...
if ! grep '^[[:space:]]*ACLOCAL_AMFLAGS[[:space:]]*=' Makefile.am >/dev/null; then
  echo -e "\nERROR: ACLOCAL_AMFLAGS not set in Makefile.am, it should contain \"-I /home/daniel/Dropbox/Hobby/Zybo_Xilinx_Xilibus/Yocto/poky/build/tmp/work/x86_64-linux/cwautomacros-native/20110201-r0/image/home/daniel/Dropbox/Hobby/Zybo_Xilinx_Xilibus/Yocto/poky/build/tmp/sysroots/x86_64-linux/usr/share/cwautomacros/m4\". Make sure you set it in all Makefile.am's."
  exit 1
fi

ACLOCAL_AMFLAGS=`grep '^[[:space:]]*ACLOCAL_AMFLAGS[[:space:]]*=' Makefile.am | sed -e 's/^[[:space:]]*ACLOCAL_AMFLAGS[[:space:]]*=[[:space:]]*//' -e 's%@ACLOCAL_CWFLAGS@%-I /home/daniel/Dropbox/Hobby/Zybo_Xilinx_Xilibus/Yocto/poky/build/tmp/work/x86_64-linux/cwautomacros-native/20110201-r0/image/home/daniel/Dropbox/Hobby/Zybo_Xilinx_Xilibus/Yocto/poky/build/tmp/sysroots/x86_64-linux/usr/share/cwautomacros/m4%g'`

if ! echo "$ACLOCAL_AMFLAGS" | grep -- '-I /home/daniel/Dropbox/Hobby/Zybo_Xilinx_Xilibus/Yocto/poky/build/tmp/work/x86_64-linux/cwautomacros-native/20110201-r0/image/home/daniel/Dropbox/Hobby/Zybo_Xilinx_Xilibus/Yocto/poky/build/tmp/sysroots/x86_64-linux/usr/share/cwautomacros/m4' >/dev/null; then
  echo "*** WARNING: ACLOCAL_AMFLAGS, in Makefile.am, should contain \"-I /home/daniel/Dropbox/Hobby/Zybo_Xilinx_Xilibus/Yocto/poky/build/tmp/work/x86_64-linux/cwautomacros-native/20110201-r0/image/home/daniel/Dropbox/Hobby/Zybo_Xilinx_Xilibus/Yocto/poky/build/tmp/sysroots/x86_64-linux/usr/share/cwautomacros/m4\""
...
if test ! -e depcomp; then
  ln -s /home/daniel/Dropbox/Hobby/Zybo_Xilinx_Xilibus/Yocto/poky/build/tmp/work/x86_64-linux/cwautomacros-native/20110201-r0/image/home/daniel/Dropbox/Hobby/Zybo_Xilinx_Xilibus/Yocto/poky/build/tmp/sysroots/x86_64-linux/usr/share/cwautomacros/scripts/depcomp.sh depcomp
fi
