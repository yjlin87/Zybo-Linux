...
CONFIG.PCW_IMPORT_BOARD_PRESET {/home/daniel/Dropbox/Hobby/Zybo_Xilinx_Xilibus/Zybo/Zybo.xml} \
...
CONFIG.PCW_WDT_WDT_IO.VALUE_SRC {DEFAULT} \
  ...
  connect_bd_intf_net -intf_net AXI_GPIO_BUTTONS_GPIO [get_bd_intf_ports Button] [get_bd_intf_pins AXI_GPIO_INPUT/GPIO]
  connect_bd_intf_net -intf_net AXI_GPIO_INPUT_GPIO2 [get_bd_intf_ports Switch] [get_bd_intf_pins AXI_GPIO_INPUT/GPIO2]
  connect_bd_intf_net -intf_net AXI_Lite_M01_AXI [get_bd_intf_pins AXI_Lite/M01_AXI] [get_bd_intf_pins AXI_TIMER_0/S_AXI]
  connect_bd_intf_net -intf_net AXI_Lite_M02_AXI [get_bd_intf_pins AXI_Lite/M02_AXI] [get_bd_intf_pins axi_fifo_mm_s_0/S_AXI]
  connect_bd_intf_net -intf_net AXI_Lite_M03_AXI [get_bd_intf_pins AXI_Lite/M03_AXI] [get_bd_intf_pins XADC/s_axi_lite]
  connect_bd_intf_net -intf_net AXI_Lite_M05_AXI [get_bd_intf_pins AXI_GPIO_INPUT/S_AXI] [get_bd_intf_pins AXI_Lite/M05_AXI]
  connect_bd_intf_net -intf_net Vaux14_1 [get_bd_intf_ports Vaux14] [get_bd_intf_pins XADC/Vaux14]
  connect_bd_intf_net -intf_net Vaux15_1 [get_bd_intf_ports Vaux15] [get_bd_intf_pins XADC/Vaux15]
  connect_bd_intf_net -intf_net Vaux6_1 [get_bd_intf_ports Vaux6] [get_bd_intf_pins XADC/Vaux6]
  connect_bd_intf_net -intf_net Vaux7_1 [get_bd_intf_ports Vaux7] [get_bd_intf_pins XADC/Vaux7]
  ...
  connect_bd_net -net AXI_GPIO_INPUT_ip2intc_irpt [get_bd_pins AXI_GPIO_INPUT/ip2intc_irpt] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net axi_timer_0_pwm0 [get_bd_ports PWM] [get_bd_pins AXI_TIMER_0/pwm0]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AXI_GPIO_INPUT/s_axi_aclk] [get_bd_pins AXI_Lite/ACLK] [get_bd_pins AXI_Lite/M00_ACLK] [get_bd_pins AXI_Lite/M01_ACLK] [get_bd_pins AXI_Lite/M02_ACLK] [get_bd_pins AXI_Lite/M03_ACLK] [get_bd_pins AXI_Lite/M04_ACLK] [get_bd_pins AXI_Lite/M05_ACLK] [get_bd_pins AXI_Lite/S00_ACLK] [get_bd_pins AXI_Lite/S01_ACLK] [get_bd_pins AXI_TIMER_0/s_axi_aclk] [get_bd_pins XADC/s_axi_aclk] [get_bd_pins axi_fifo_mm_s_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins AXI_Lite/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins AXI_GPIO_INPUT/s_axi_aresetn] [get_bd_pins AXI_Lite/M00_ARESETN] [get_bd_pins AXI_Lite/M01_ARESETN] [get_bd_pins AXI_Lite/M02_ARESETN] [get_bd_pins AXI_Lite/M03_ARESETN] [get_bd_pins AXI_Lite/M04_ARESETN] [get_bd_pins AXI_Lite/M05_ARESETN] [get_bd_pins AXI_Lite/S00_ARESETN] [get_bd_pins AXI_Lite/S01_ARESETN] [get_bd_pins AXI_TIMER_0/s_axi_aresetn] [get_bd_pins XADC/s_axi_aresetn] [get_bd_pins axi_fifo_mm_s_0/s_axi_aresetn] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x41210000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AXI_GPIO_INPUT/S_AXI/Reg] SEG_AXI_GPIO_BUTTONS_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs XADC/s_axi_lite/Reg] SEG_xadc_wiz_0_Reg
...
preplace port Vp_Vn -pg 1 -y 130 -defaultsOSRD
preplace port PWM -pg 1 -y 700 -defaultsOSRD
preplace port Button -pg 1 -y 830 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 1120 -defaultsOSRD
preplace port Vaux6 -pg 1 -y 150 -defaultsOSRD
preplace port Vaux7 -pg 1 -y 170 -defaultsOSRD
preplace port Vaux14 -pg 1 -y 190 -defaultsOSRD
preplace port Vaux15 -pg 1 -y 210 -defaultsOSRD
preplace port Switch -pg 1 -y 850 -defaultsOSRD
preplace inst AXI_Lite -pg 1 -lvl 2 -y 780 -defaultsOSRD
preplace inst rst_processing_system7_0_100M -pg 1 -lvl 2 -y 410 -defaultsOSRD
preplace inst AXI_GPIO_INPUT -pg 1 -lvl 3 -y 850 -defaultsOSRD
preplace inst XADC -pg 1 -lvl 1 -y 180 -defaultsOSRD
preplace inst AXI_TIMER_0 -pg 1 -lvl 3 -y 690 -defaultsOSRD
preplace inst axi_fifo_mm_s_0 -pg 1 -lvl 2 -y 120 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 2 -y 1230 -defaultsOSRD
preplace netloc Vaux6_1 1 0 1 NJ
preplace netloc processing_system7_0_DDR 1 2 2 NJ 1100 NJ
preplace netloc Vaux7_1 1 0 1 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 1 2 390 530 800
preplace netloc Vp_Vn_1 1 0 1 N
preplace netloc AXI_GPIO_BUTTONS_GPIO 1 3 1 NJ
preplace netloc AXI_Lite_M02_AXI 1 1 2 350 1030 790
preplace netloc axi_timer_0_pwm0 1 3 1 NJ
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 2 360 1050 790
preplace netloc AXI_GPIO_INPUT_ip2intc_irpt 1 1 3 370 520 NJ 520 1080
preplace netloc AXI_GPIO_INPUT_GPIO2 1 3 1 NJ
preplace netloc AXI_Lite_M01_AXI 1 2 1 820
preplace netloc AXI_Lite_M03_AXI 1 0 3 20 10 NJ 10 810
preplace netloc axi_fifo_mm_s_0_AXI_STR_TXD 1 1 2 390 20 800
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 0 3 30 360 340 510 830
preplace netloc AXI_Lite_M05_AXI 1 2 1 N
preplace netloc Vaux14_1 1 0 1 NJ
preplace netloc processing_system7_0_FIXED_IO 1 2 2 NJ 1120 NJ
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 1 2 380 500 800
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 350 330 1040 840
preplace netloc Vaux15_1 1 0 1 NJ
levelinfo -pg 1 0 180 590 960 1100 -top 0 -bot 1410
",
}
