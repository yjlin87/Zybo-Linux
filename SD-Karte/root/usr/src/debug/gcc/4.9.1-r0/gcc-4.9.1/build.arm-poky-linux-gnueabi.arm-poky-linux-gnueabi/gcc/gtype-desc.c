...
void
gt_ggc_mx_vec_ipa_edge_args_va_gc_ (void *x_p)
{
  vec<ipa_edge_args,va_gc> * const x = (vec<ipa_edge_args,va_gc> *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_mx (x);
    }
...
void
gt_ggc_mx (struct gimple_statement_base *& x)
{
  if (x)
...
gt_ggc_mx_tm_restart_node (void *x_p)
{
  ...
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_m_21gimple_statement_base ((*x).stmt);
...
void
gt_ggc_mx_pointer_map_t (void *x_p)
{
  struct pointer_map_t * const x = (struct pointer_map_t *)x_p;
  if (ggc_test_and_set_mark (x))
    {
    }
}
...
{
  struct dw_loc_descr_node * const x = (struct dw_loc_descr_node *)x_p;
  if (ggc_test_and_set_mark (x))
    {
        ...
        case SYMTAB_FUNCTION:
          {
            ...
            gt_ggc_m_11symtab_node ((*sub).global.inlined_to);
            gt_ggc_m_28vec_ipa_replace_map_p_va_gc_ ((*sub).clone.tree_map);
            gt_ggc_m_11bitmap_head ((*sub).clone.args_to_skip);
            gt_ggc_m_11bitmap_head ((*sub).clone.combined_args_to_skip);
  ...
  if (ggc_test_and_set_mark (x))
    {
      ...
      gt_ggc_m_21gimple_statement_base ((*x).gimple_body);
      ...
      gt_ggc_m_9tree_node ((*x).cilk_frame_decl);
...
gt_ggc_mx_bitmap_obstack (void *x_p)
{
  ...
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_m_14bitmap_element ((*x).elements);
      gt_ggc_m_11bitmap_head ((*x).heads);
    }
}
  ...
  while (x != xlimit)
    {
      ...
      switch (((((*x)).flags & BB_RTL) != 0))
        {
        case 0:
          gt_ggc_m_21gimple_statement_base ((*x).il.gimple.seq);
          gt_ggc_m_21gimple_statement_base ((*x).il.gimple.phi_nodes);
          break;
        case 1:
...
void
gt_ggc_mx_gimple_statement_base (void *x_p)
{
  struct gimple_statement_base * x = (struct gimple_statement_base *)x_p;
  struct gimple_statement_base * xlimit = x;
  while (ggc_test_and_set_mark (xlimit))
   xlimit = ((*xlimit).next);
  while (x != xlimit)
    {
      switch (gimple_statement_structure (&((*x))))
        ...
        case GSS_BASE:
          ...
          gt_ggc_m_21gimple_statement_base ((*x).next);
          break;
        case GSS_BIND:
          {
            gimple_statement_bind *sub = static_cast <gimple_statement_bind *> (x);
            gt_ggc_m_9tree_node ((*sub).vars);
            gt_ggc_m_9tree_node ((*sub).block);
            gt_ggc_m_21gimple_statement_base ((*sub).body);
            gt_ggc_m_15basic_block_def ((*sub).bb);
            gt_ggc_m_21gimple_statement_base ((*sub).next);
          }
          break;
        case GSS_CATCH:
          {
            gimple_statement_catch *sub = static_cast <gimple_statement_catch *> (x);
            gt_ggc_m_9tree_node ((*sub).types);
            gt_ggc_m_21gimple_statement_base ((*sub).handler);
            gt_ggc_m_15basic_block_def ((*sub).bb);
            gt_ggc_m_21gimple_statement_base ((*sub).next);
          }
          break;
        case GSS_EH_FILTER:
          {
            gimple_statement_eh_filter *sub = static_cast <gimple_statement_eh_filter *> (x);
            gt_ggc_m_9tree_node ((*sub).types);
            gt_ggc_m_21gimple_statement_base ((*sub).failure);
            gt_ggc_m_15basic_block_def ((*sub).bb);
            gt_ggc_m_21gimple_statement_base ((*sub).next);
          }
          break;
        case GSS_EH_ELSE:
          {
            gimple_statement_eh_else *sub = static_cast <gimple_statement_eh_else *> (x);
            gt_ggc_m_21gimple_statement_base ((*sub).n_body);
            gt_ggc_m_21gimple_statement_base ((*sub).e_body);
            gt_ggc_m_15basic_block_def ((*sub).bb);
            gt_ggc_m_21gimple_statement_base ((*sub).next);
          }
          break;
        case GSS_EH_MNT:
          {
            gimple_statement_eh_mnt *sub = static_cast <gimple_statement_eh_mnt *> (x);
        ...
        case GSS_PHI:
          {
            gimple_statement_phi *sub = static_cast <gimple_statement_phi *> (x);
            {
              size_t l0 = (size_t)(((*sub)).nargs);
              gt_ggc_m_9tree_node ((*sub).result);
              {
                size_t i0;
                for (i0 = 0; i0 != l0; i0++) {
                  gt_ggc_m_9tree_node ((*sub).args[i0].def);
                }
              }
              gt_ggc_m_15basic_block_def ((*sub).bb);
              gt_ggc_m_21gimple_statement_base ((*sub).next);
        ...
        case GSS_TRY:
          {
            gimple_statement_try *sub = static_cast <gimple_statement_try *> (x);
            gt_ggc_m_21gimple_statement_base ((*sub).eval);
            gt_ggc_m_21gimple_statement_base ((*sub).cleanup);
            gt_ggc_m_15basic_block_def ((*sub).bb);
            gt_ggc_m_21gimple_statement_base ((*sub).next);
          }
          break;
        ...
        case GSS_OMP_CONTINUE:
          {
            gimple_statement_omp_continue *sub = static_cast <gimple_statement_omp_continue *> (x);
        ...
        case GSS_OMP_CRITICAL:
          {
            gimple_statement_omp_critical *sub = static_cast <gimple_statement_omp_critical *> (x);
        ...
        case GSS_OMP_FOR:
          {
            gimple_statement_omp_for *sub = static_cast <gimple_statement_omp_for *> (x);
            {
              size_t l1 = (size_t)(((*sub)).collapse);
              gt_ggc_m_9tree_node ((*sub).clauses);
              if ((*sub).iter != NULL) {
                size_t i1;
                for (i1 = 0; i1 != (size_t)(l1); i1++) {
                  gt_ggc_m_9tree_node ((*sub).iter[i1].index);
                  gt_ggc_m_9tree_node ((*sub).iter[i1].initial);
                  gt_ggc_m_9tree_node ((*sub).iter[i1].final);
                  gt_ggc_m_9tree_node ((*sub).iter[i1].incr);
                }
                ggc_mark ((*sub).iter);
              }
              gt_ggc_m_21gimple_statement_base ((*sub).pre_body);
              gt_ggc_m_21gimple_statement_base ((*sub).body);
              gt_ggc_m_15basic_block_def ((*sub).bb);
              gt_ggc_m_21gimple_statement_base ((*sub).next);
            }
        ...
        case GSS_OMP_TASK:
          {
            gimple_statement_omp_task *sub = static_cast <gimple_statement_omp_task *> (x);
        ...
        case GSS_OMP_SECTIONS:
          {
            gimple_statement_omp_sections *sub = static_cast <gimple_statement_omp_sections *> (x);
            gt_ggc_m_9tree_node ((*sub).clauses);
        ...
        case GSS_OMP_ATOMIC_LOAD:
          {
            gimple_statement_omp_atomic_load *sub = static_cast <gimple_statement_omp_atomic_load *> (x);
        ...
        case GSS_ASM:
          {
            gimple_statement_asm *sub = static_cast <gimple_statement_asm *> (x);
            {
        ...
        case GSS_TRANSACTION:
          {
            gimple_statement_transaction *sub = static_cast <gimple_statement_transaction *> (x);
            gt_ggc_m_21gimple_statement_base ((*sub).body);
            gt_ggc_m_9tree_node ((*sub).label);
            gt_ggc_m_15basic_block_def ((*sub).bb);
            gt_ggc_m_21gimple_statement_base ((*sub).next);
          }
          break;
...
void
gt_ggc_m_P28cgraph_function_version_info4htab (void *x_p)
{
  struct htab * const x = (struct htab *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      {
        ...
        if ((*x).entries != NULL) {
          size_t i0;
          for (i0 = 0; i0 != (size_t)(l0); i0++) {
            gt_ggc_m_28cgraph_function_version_info ((*x).entries[i0]);
          }
          ggc_mark ((*x).entries);
        }
      }
...
void
gt_ggc_m_P11symtab_node4htab (void *x_p)
{
  struct htab * const x = (struct htab *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      {
        ...
        if ((*x).entries != NULL) {
          size_t i0;
          for (i0 = 0; i0 != (size_t)(l0); i0++) {
            gt_ggc_m_11symtab_node ((*x).entries[i0]);
          }
          ggc_mark ((*x).entries);
        }
      }
...
void
gt_pch_nx_vec_ipa_edge_args_va_gc_ (void *x_p)
{
  vec<ipa_edge_args,va_gc> * const x = (vec<ipa_edge_args,va_gc> *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_24vec_ipa_edge_args_va_gc_))
    {
      gt_pch_nx (x);
    }
}
...
void
gt_pch_nx (struct gimple_statement_base *& x)
{
  if (x)
    gt_pch_nx_gimple_statement_base ((void *) x);
}
...
gt_pch_nx_tm_restart_node (void *x_p)
{
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_15tm_restart_node))
    {
      gt_pch_n_21gimple_statement_base ((*x).stmt);
...
void
gt_pch_nx_pointer_map_t (void *x_p)
{
  struct pointer_map_t * const x = (struct pointer_map_t *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_13pointer_map_t))
    {
    }
}
...
{
  struct dw_loc_descr_node * const x = (struct dw_loc_descr_node *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_17dw_loc_descr_node))
    {
  ...
  while (x != xlimit)
    {
      ...
      gt_pch_n_21gimple_statement_base ((*x).call_stmt);
        ...
        case SYMTAB_FUNCTION:
          {
            ...
            gt_pch_n_P11cgraph_edge4htab ((*sub).call_site_hash);
            gt_pch_n_9tree_node ((*sub).former_clone_of);
            gt_pch_n_17cgraph_simd_clone ((*sub).simdclone);
            gt_pch_n_11symtab_node ((*sub).simd_clones);
            gt_pch_n_11symtab_node ((*sub).global.inlined_to);
            gt_pch_n_28vec_ipa_replace_map_p_va_gc_ ((*sub).clone.tree_map);
            gt_pch_n_11bitmap_head ((*sub).clone.args_to_skip);
            gt_pch_n_11bitmap_head ((*sub).clone.combined_args_to_skip);
...
gt_pch_nx_target_globals (void *x_p)
{
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_14target_globals))
    {
      if ((*x).regs != NULL) {
        gt_pch_note_object ((*x).regs, x, gt_pch_p_14target_globals);
      }
      gt_pch_n_10target_rtl ((*x).rtl);
      if ((*x).hard_regs != NULL) {
        gt_pch_note_object ((*x).hard_regs, x, gt_pch_p_14target_globals);
      }
      if ((*x).reload != NULL) {
        gt_pch_note_object ((*x).reload, x, gt_pch_p_14target_globals);
      }
      if ((*x).expmed != NULL) {
        gt_pch_note_object ((*x).expmed, x, gt_pch_p_14target_globals);
      }
      gt_pch_n_15target_libfuncs ((*x).libfuncs);
      if ((*x).ira != NULL) {
        gt_pch_note_object ((*x).ira, x, gt_pch_p_14target_globals);
      }
      if ((*x).ira_int != NULL) {
        gt_pch_note_object ((*x).ira_int, x, gt_pch_p_14target_globals);
      }
      if ((*x).lra_int != NULL) {
        gt_pch_note_object ((*x).lra_int, x, gt_pch_p_14target_globals);
      }
    }
}
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_8function))
    {
      ...
      gt_pch_n_21gimple_statement_base ((*x).gimple_body);
      ...
      gt_pch_n_9tree_node ((*x).cilk_frame_decl);
...
gt_pch_nx_bitmap_obstack (void *x_p)
{
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_14bitmap_obstack))
    {
      gt_pch_n_14bitmap_element ((*x).elements);
      gt_pch_n_11bitmap_head ((*x).heads);
    }
}
    ...
    for (;;)
      {
        ...
        if (xprev == NULL) break;
        x = xprev;
        (void) gt_pch_note_object (xprev, xprev, gt_pch_p_14bitmap_element);
      }
  while (x != xlimit)
    {
  ...
  while (x != xlimit)
    {
      ...
      switch (((((*x)).flags & BB_RTL) != 0))
        {
        case 0:
          gt_pch_n_21gimple_statement_base ((*x).il.gimple.seq);
          gt_pch_n_21gimple_statement_base ((*x).il.gimple.phi_nodes);
          break;
        case 1:
...
void
gt_pch_nx_gimple_statement_base (void *x_p)
{
  struct gimple_statement_base * x = (struct gimple_statement_base *)x_p;
  struct gimple_statement_base * xlimit = x;
  ...
  while (x != xlimit)
    {
      switch (gimple_statement_structure (&((*x))))
        ...
        case GSS_BASE:
          ...
          gt_pch_n_21gimple_statement_base ((*x).next);
          break;
        case GSS_BIND:
          {
            gimple_statement_bind *sub = static_cast <gimple_statement_bind *> (x);
            ...
            gt_pch_n_21gimple_statement_base ((*sub).body);
            gt_pch_n_15basic_block_def ((*sub).bb);
            gt_pch_n_21gimple_statement_base ((*sub).next);
          }
          break;
        case GSS_CATCH:
          {
            ...
            gt_pch_n_21gimple_statement_base ((*sub).handler);
            gt_pch_n_15basic_block_def ((*sub).bb);
            gt_pch_n_21gimple_statement_base ((*sub).next);
          }
          break;
        case GSS_EH_FILTER:
          {
            gimple_statement_eh_filter *sub = static_cast <gimple_statement_eh_filter *> (x);
            gt_pch_n_9tree_node ((*sub).types);
            gt_pch_n_21gimple_statement_base ((*sub).failure);
            gt_pch_n_15basic_block_def ((*sub).bb);
            gt_pch_n_21gimple_statement_base ((*sub).next);
          }
          break;
        case GSS_EH_ELSE:
          {
            gimple_statement_eh_else *sub = static_cast <gimple_statement_eh_else *> (x);
            gt_pch_n_21gimple_statement_base ((*sub).n_body);
            gt_pch_n_21gimple_statement_base ((*sub).e_body);
            gt_pch_n_15basic_block_def ((*sub).bb);
            gt_pch_n_21gimple_statement_base ((*sub).next);
          }
          break;
        ...
        case GSS_PHI:
          {
            gimple_statement_phi *sub = static_cast <gimple_statement_phi *> (x);
            {
              ...
              gt_pch_n_9tree_node ((*sub).result);
              {
                size_t i0;
                for (i0 = 0; i0 != l0; i0++) {
                  gt_pch_n_9tree_node ((*sub).args[i0].def);
                }
              }
              gt_pch_n_15basic_block_def ((*sub).bb);
              gt_pch_n_21gimple_statement_base ((*sub).next);
        ...
        case GSS_TRY:
          {
            gimple_statement_try *sub = static_cast <gimple_statement_try *> (x);
            gt_pch_n_21gimple_statement_base ((*sub).eval);
            gt_pch_n_21gimple_statement_base ((*sub).cleanup);
            gt_pch_n_15basic_block_def ((*sub).bb);
            gt_pch_n_21gimple_statement_base ((*sub).next);
          }
          break;
        ...
        case GSS_OMP_FOR:
          {
            gimple_statement_omp_for *sub = static_cast <gimple_statement_omp_for *> (x);
            {
              ...
              if ((*sub).iter != NULL) {
                size_t i1;
                for (i1 = 0; i1 != (size_t)(l1); i1++) {
                  gt_pch_n_9tree_node ((*sub).iter[i1].index);
                  gt_pch_n_9tree_node ((*sub).iter[i1].initial);
                  gt_pch_n_9tree_node ((*sub).iter[i1].final);
                  gt_pch_n_9tree_node ((*sub).iter[i1].incr);
                }
                gt_pch_note_object ((*sub).iter, x, gt_pch_p_21gimple_statement_base);
              }
              gt_pch_n_21gimple_statement_base ((*sub).pre_body);
              gt_pch_n_21gimple_statement_base ((*sub).body);
              gt_pch_n_15basic_block_def ((*sub).bb);
              gt_pch_n_21gimple_statement_base ((*sub).next);
            }
...
void
gt_pch_n_P28cgraph_function_version_info4htab (void *x_p)
{
  struct htab * const x = (struct htab *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_P28cgraph_function_version_info4htab))
    {
      {
        size_t l0 = (size_t)(((*x)).size);
        if ((*x).entries != NULL) {
          size_t i0;
          for (i0 = 0; i0 != (size_t)(l0); i0++) {
            gt_pch_n_28cgraph_function_version_info ((*x).entries[i0]);
          }
          gt_pch_note_object ((*x).entries, x, gt_pch_p_P28cgraph_function_version_info4htab);
        }
      }
    }
}
...
void
gt_pch_n_P11symtab_node4htab (void *x_p)
{
  struct htab * const x = (struct htab *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_P11symtab_node4htab))
    {
      {
        size_t l0 = (size_t)(((*x)).size);
        if ((*x).entries != NULL) {
          size_t i0;
          for (i0 = 0; i0 != (size_t)(l0); i0++) {
            gt_pch_n_11symtab_node ((*x).entries[i0]);
          }
          gt_pch_note_object ((*x).entries, x, gt_pch_p_P11symtab_node4htab);
        }
      }
    }
}
...
void
gt_pch_p_24vec_ipa_edge_args_va_gc_ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct vec<ipa_edge_args,va_gc> * x ATTRIBUTE_UNUSED = (struct vec<ipa_edge_args,va_gc> *)x_p;
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x)), op, cookie);
}
...
void
gt_pch_p_13pointer_map_t (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct pointer_map_t * x ATTRIBUTE_UNUSED = (struct pointer_map_t *)x_p;
}
    ...
    case SYMTAB_FUNCTION:
      {
        ...
        if ((void *)(x) == this_obj)
          op (&((*sub).global.inlined_to), cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).clone.tree_map), cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).clone.args_to_skip), cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).clone.combined_args_to_skip), cookie);
        if ((void *)(x) == this_obj)
...
void
gt_pch_p_21gimple_statement_base (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct gimple_statement_base * x ATTRIBUTE_UNUSED = (struct gimple_statement_base *)x_p;
  switch (gimple_statement_structure (&((*x))))
    {
    case GSS_BASE:
      if ((void *)(x) == this_obj)
    ...
    case GSS_OMP_FOR:
      {
        gimple_statement_omp_for *sub = static_cast <gimple_statement_omp_for *> (x);
        {
          ...
          if ((*sub).iter != NULL) {
            size_t i1;
            for (i1 = 0; i1 != (size_t)(l1) && ((void *)(*sub).iter == this_obj); i1++) {
              if ((void *)((*sub).iter) == this_obj)
                op (&((*sub).iter[i1].index), cookie);
              if ((void *)((*sub).iter) == this_obj)
                op (&((*sub).iter[i1].initial), cookie);
              if ((void *)((*sub).iter) == this_obj)
                op (&((*sub).iter[i1].final), cookie);
              if ((void *)((*sub).iter) == this_obj)
                op (&((*sub).iter[i1].incr), cookie);
            }
            if ((void *)(x) == this_obj)
              op (&((*sub).iter), cookie);
          }
...
void
gt_pch_p_P28cgraph_function_version_info4htab (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
...
void
gt_pch_p_P11symtab_node4htab (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
...
void * ggc_alloc_splay_tree_tree_type_map_htab (int sz, void * nl)
{
  return ggc_splay_alloc (sz, nl);
}
...
void * ggc_alloc_splay_tree_cgraph_function_version_info_htab (int sz, void * nl)
{
  return ggc_splay_alloc (sz, nl);
}
...
void * ggc_alloc_splay_tree_symtab_node_htab (int sz, void * nl)
{
  return ggc_splay_alloc (sz, nl);
}
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gtype_desc_c[] = {
  ...
  },
  {
    ...
    &gt_ggc_mx_vec_ipa_edge_args_va_gc_,
    &gt_pch_nx_vec_ipa_edge_args_va_gc_
  },
  {
  ...
  },
  {
    ...
    1,
    sizeof (symtab_nodes),
    &gt_ggc_mx_symtab_node,
    &gt_pch_nx_symtab_node
  },
  {
    &in_section,
    1,
