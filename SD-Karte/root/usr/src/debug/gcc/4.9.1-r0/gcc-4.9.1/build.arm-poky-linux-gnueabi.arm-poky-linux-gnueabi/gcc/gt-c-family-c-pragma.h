...
void
gt_ggc_mx (struct pending_redefinition_d& x_r ATTRIBUTE_UNUSED)
{
  struct pending_redefinition_d * ATTRIBUTE_UNUSED x = &x_r;
...
void
gt_ggc_mx (struct pending_weak_d& x_r ATTRIBUTE_UNUSED)
{
  struct pending_weak_d * ATTRIBUTE_UNUSED x = &x_r;
...
void
gt_pch_nx (struct pending_redefinition_d& x_r ATTRIBUTE_UNUSED)
{
  struct pending_redefinition_d * ATTRIBUTE_UNUSED x = &x_r;
...
void
gt_pch_nx (struct pending_weak_d& x_r ATTRIBUTE_UNUSED)
{
  struct pending_weak_d * ATTRIBUTE_UNUSED x = &x_r;
...
void
gt_pch_nx (struct pending_redefinition_d* x ATTRIBUTE_UNUSED,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
    op (&((*x).oldname), cookie);
...
void
gt_pch_nx (struct pending_weak_d* x ATTRIBUTE_UNUSED,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
    op (&((*x).name), cookie);
