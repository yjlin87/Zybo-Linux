        ...
        case TS_LTO_GENERIC:
          switch (tree_node_structure (&((*x).generic)))
            ...
            case TS_SSA_NAME:
              ...
              switch (((*x).generic.ssa_name).typed.type ?!POINTER_TYPE_P (TREE_TYPE ((tree)&((*x).generic.ssa_name))) : 2)
                {
                case 0:
...
extern const struct ggc_cache_tab gt_ggc_rc_gt_ubsan_h[];
...
extern const struct ggc_root_tab gt_pch_rc_gt_ubsan_h[];
