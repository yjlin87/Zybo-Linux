...
tie %Config, 'Config', {
    ...
    archlibexp => '/usr/lib/perl/5.20.0/',
    archname => 'arm-linux-gnueabi',
    cc => 'arm-poky-linux-gnueabi-gcc  -march=armv7-a -mthumb-interwork -mfloat-abi=softfp -mfpu=neon ',
    cccdlflags => '-fPIC',
    ...
    intsize => '4',
    ld => 'arm-poky-linux-gnueabi-gcc  -march=armv7-a -mthumb-interwork -mfloat-abi=softfp -mfpu=neon ',
